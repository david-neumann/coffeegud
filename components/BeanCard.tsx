...
const BeanCard: FC<BeanCardProps> = ({
  ...
  return (
    <Link href={`/beans/${coffeeName?.toLowerCase().replace(/\s+/g, "")}`}>
      <motion.section
        whileHover={{ scale: 1.03 }}
        className="cursor-pointer rounded-xl bg-slate-100 p-1 shadow dark:bg-slate-700"
      >
        ...
        <div className="flex gap-2 p-2">
          <div className="w-1/3">
            <div className="flex items-center gap-1">
              ...
              />
              <h4 className=" text-xs uppercase tracking-wider text-emerald-400 dark:text-emerald-300">
                Country
              </h4>
            </div>
          ...
          <div className="w-1/4">
            <div className="flex items-center gap-1">
              <Clock
                size={12}
                strokeWidth={1.5}
                className="inline stroke-emerald-400 dark:stroke-emerald-300"
              />
              <h4 className=" text-xs uppercase tracking-wider text-emerald-400 dark:text-emerald-300">
                Rest
              </h4>
          ...
          <div className="">
            <div className="flex items-center gap-1">
              <Scale
                size={12}
                strokeWidth={1.5}
                className="-mt-[1px] inline stroke-emerald-400 dark:stroke-emerald-300"
              />
              <h4 className=" text-xs uppercase tracking-wider text-emerald-400 dark:text-emerald-300">
                Remaining
              </h4>
